...
import static com.infamousmisadventures.factioncraft.config.FactionCraftConfig.ENABLE_RECONSTRUCT_BLOCKS;
import static com.infamousmisadventures.factioncraft.registry.FCBlockEntityTypes.RECONSTRUCT_BLOCK_ENTITY;
...
public class ReconstructBlockEntity extends BlockEntity {
    ...
    public ReconstructBlockEntity(BlockPos p_155229_, BlockState p_155230_) {
        super(RECONSTRUCT_BLOCK_ENTITY.get(), p_155229_, p_155230_);
    }
