package com.infamousmisadventures.factioncraft.config;
    ...
    public static class Common {
        ...
        private void factionConfig(ForgeConfigSpec.Builder builder) {
            ...
            DISABLED_FACTIONS = builder
                    ...
                    .defineList("disabledFactions", Arrays.asList(MOD_ID+":skeleton_test", MOD_ID+":slime_test"), o -> o instanceof String);
