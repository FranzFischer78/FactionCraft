...
public interface IRegistrar {
    ...
    /**
     * Main method for this service interface, called in {@link FactionCraft} in order to load it and its loader-specific implementations accordingly. Should NOT be called anywhere else!
     */
    void setupRegistrar();
