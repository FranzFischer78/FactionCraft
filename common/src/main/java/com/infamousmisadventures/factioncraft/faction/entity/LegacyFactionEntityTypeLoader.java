...
public class LegacyFactionEntityTypeLoader {
    public static FactionEntityType load(CompoundTag compoundNbt) {
        if (compoundNbt.contains("factionEntityType")) {
            ...
            if (FCFactionEntityTypes.getFactionEntityType(factionEntityType) != null) {
                return FCFactionEntityTypes.getFactionEntityType(factionEntityType);
            } else {
    ...
    public static CompoundTag saveStatic(FactionEntityType factionEntityType, CompoundTag compoundNbt) {
        ResourceLocation factionEntityTypeResource = FCFactionEntityTypes.getFactionEntityTypeKey(factionEntityType);
