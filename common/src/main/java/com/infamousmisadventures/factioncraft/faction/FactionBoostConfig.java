...
public class FactionBoostConfig {
    ...
    public enum BoostDistributionType{
        ...
        public static final Codec<BoostDistributionType> CODEC = Codec.STRING.flatComapMap(s -> BoostDistributionType.byName(s, null), d -> DataResult.success(d.getName()));
        ...
        public static BoostDistributionType byName(String name, BoostDistributionType defaultType) {
            for(BoostDistributionType distributionType : values()) {
