...
public class FactionEntityType {
    public static final FactionEntityType DEFAULT = new FactionEntityType(new ResourceLocation("minecraft:pig"), new CompoundTag(), false, true, 1, 1, List.of(FactionEntityRank.SOLDIER), EntityBoostConfig.DEFAULT, new IntRange(0, 10000), new IntRange(0, 10000), Integer.MAX_VALUE, new IntRange(0, 10000), new IntRange(-64, 320), ResourceSet.getEmpty(BIOME), ResourceSet.getEmpty(BIOME), Integer.MAX_VALUE);
    public static final Codec<FactionEntityType> CODEC = RecordCodecBuilder.create(builder ->
            builder.group(
                    ...
                    ResourceSet.getCodec(BIOME).optionalFieldOf("biome_whitelist", ResourceSet.getEmpty(BIOME)).forGetter(data -> data.biomeWhitelist),
                    ResourceSet.getCodec(BIOME).optionalFieldOf("biome_blacklist", ResourceSet.getEmpty(BIOME)).forGetter(data -> data.biomeBlacklist),
    ...
    public EntityType<?> getEntityType() {
        return ENTITY_TYPE.get(entityType);
    }
        ...
        entity.getRootVehicle().getSelfAndPassengers()
                .forEach(stackedEntity -> {
                    if (stackedEntity instanceof Mob mob) {
                        FactionEntityData cap = ((IFactionEntityDataHolder) mob).getOrCreateFactionEntityData();
    ...
    public CompoundTag save(CompoundTag compoundNbt) {
        ResourceLocation factionEntityTypeResource = FCFactionEntityTypes.getFactionEntityTypeKey(this);
