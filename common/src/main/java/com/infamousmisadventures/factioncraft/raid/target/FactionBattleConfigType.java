...
public class FactionBattleConfigType extends RaidConfigType {
    public static final FactionBattleConfigType DEFAULT = new FactionBattleConfigType(WaveRaidConfig.DEFAULT, DEFAULT_MOBS_FRACTION, "event.minecraft.raid", "event.minecraft.raid.victory", "event.minecraft.raid.defeat", Optional.of(SoundEvents.RAID_HORN), Optional.empty(), Optional.of(SoundEvents.RAID_HORN));
    public static final Codec<FactionBattleConfigType> CODEC = RecordCodecBuilder.create(builder ->
            builder.group(
                    WaveRaidConfig.CODEC.optionalFieldOf("wave_raid_config", WaveRaidConfig.DEFAULT).forGetter(FactionBattleConfigType::getWaveRaidConfig),
    ...
    public FactionBattleConfigType(WaveRaidConfig waveRaidConfig, float mobsFraction, String raidBarName, String raidBarVictory, String raidBarDefeat, Optional<Holder<SoundEvent>> waveSoundEvent, Optional<Holder<SoundEvent>> victorySoundEvent, Optional<Holder<SoundEvent>> defeatSoundEvent) {
